                                        ...
                                        <table class="table table-bordered align-middle mb-0">
                                            <thead>
                                                <tr class="text-center">
                                                    ...
                                                    <th class="w-120">Bảo trì (tháng)</th>
...
@section('script')
    ...
    <script>
        ...
        `);
            ...
            /* ========= Submit: chuẩn hóa dữ liệu ========= */
            // $('form.needs-validation').on('submit', function(e) {
            //     // Nếu có slug thì ép lần cuối (không có thì thôi)
            //     if ($('#slug').length && !($('#slug').val() || '').trim()) {
            //         $('#slug').val(toSlug($('#name').val()));
            //     }

            //     // Ép MISA IN HOA lần cuối
            //     $('#code_misa').val(($('#code_misa').val() || '').trim().toUpperCase());

            //     // Bỏ dấu chấm trong price / price_sale
            //     $('#price').val(($('#price').val() || '').replace(/\D/g, ''));
            //     $('#price_sale').val(($('#price_sale').val() || '').replace(/\D/g, ''));
