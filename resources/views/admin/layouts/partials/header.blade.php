    ...
    <div class="d-flex">
        ...
        <div class="navbar-brand-box">
            <a href="" class="logo logo-dark">
                <span class="logo-sm">
                    <img src="{{ asset('theme/admin/assets/images/logo.svg') }}" alt="" height="22">
                </span>
                <span class="logo-lg">
            ...
            <a href="" class="logo logo-light">
                <span class="logo-sm">
                    <img src="{{ asset('theme/admin/assets/images/logo-light.svg') }}" alt="" height="22">
                </span>
                <span class="logo-lg">
                    <img src="{{ asset('theme/admin/assets/images/logo-light.png') }}" alt="" height="19">
                </span>
            </a>
        </div>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-4">
                        <div class="row">
                            ...
                            <div class="col-sm-5">
                                <div>
                                    <img src="{{ asset('theme/admin/assets/images/megamenu-img.png') }}"
    ...
    <div class="d-flex">
        ...
        <div class="dropdown d-inline-block">
            <button type="button" class="btn header-item waves-effect" data-bs-toggle="dropdown"
                ...
                <img id="header-lang-img" src="{{ asset('theme/admin/assets/images/flags/us.jpg') }}"
            ...
            <div class="dropdown-menu dropdown-menu-end">
                ...
                <a href="javascript:void(0);" class="dropdown-item notify-item language" data-lang="en">
                    <img src="{{ asset('theme/admin/assets/images/flags/us.jpg') }}" alt="user-image" class="me-1"
                        height="12"> <span class="align-middle">English</span>
                </a>
                <!-- item-->
                <a href="javascript:void(0);" class="dropdown-item notify-item language" data-lang="sp">
                    <img src="{{ asset('theme/admin/assets/images/flags/spain.jpg') }}" alt="user-image"
                        class="me-1" height="12"> <span class="align-middle">Spanish</span>
                </a>

                <!-- item-->
                <a href="javascript:void(0);" class="dropdown-item notify-item language" data-lang="gr">
                    <img src="{{ asset('theme/admin/assets/images/flags/germany.jpg') }}" alt="user-image"
                        class="me-1" height="12"> <span class="align-middle">German</span>
                </a>

                <!-- item-->
                <a href="javascript:void(0);" class="dropdown-item notify-item language" data-lang="it">
                    <img src="{{ asset('theme/admin/assets/images/flags/italy.jpg') }}" alt="user-image"
                        class="me-1" height="12"> <span class="align-middle">Italian</span>
                </a>

                <!-- item-->
                <a href="javascript:void(0);" class="dropdown-item notify-item language" data-lang="ru">
                    <img src="{{ asset('theme/admin/assets/images/flags/russia.jpg') }}" alt="user-image"
        ...
        <div class="dropdown d-inline-block">
            <button type="button" class="btn header-item waves-effect" id="page-header-user-dropdown"
                ...
                @else
                    <img class="rounded-circle header-profile-user"
                        src="{{ asset('theme/admin/assets/images/avata_unknow.png') }}" alt="Header Avatar">
                    <span class="fw-bold"></span>
                @endif
            ...
            <div class="dropdown-menu dropdown-menu-end">
                <!-- item-->
                <a class="dropdown-item" href="index.html#"><i class="bx bx-user font-size-16 align-middle me-1"></i>
